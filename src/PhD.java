...
public class PhD {
    ...
    public boolean isPhDSibling(PhD p) {
        ...
        return !p.equals(this) && (p.getAdvisor1() != null || p.getAdvisor2() != null) &&
                (p.getAdvisor1().equals(this.getAdvisor1()) || p.getAdvisor1().equals(this.getAdvisor2())
                        || p.getAdvisor2().equals(this.getAdvisor1()) || p.getAdvisor2().equals(this.getAdvisor2()));
    }
}